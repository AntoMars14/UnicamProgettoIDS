...
public class POIFD {
    ...
    public POIFD(int id, String name, String description, Coordinates coord, Type type, List<ContentGI> contentsGI) {
        this.id = id;
        this.name = name;
    ...
    public POIFD(int id, String name, String description, Coordinates coord, Type type, LocalTime[] ot, LocalTime[] ct, List<ContentGI> contentsGI) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.coordinates = coord;
    ...
    public POIFD(int id, String name, String description, Coordinates coord, Type type, LocalDateTime od, LocalDateTime cd, List<ContentGI> contentsGI) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.coordinates = coord;
